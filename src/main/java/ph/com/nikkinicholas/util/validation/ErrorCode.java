...
public enum ErrorCode {
    ...
    SUBJECT_CODE_MISSING("SUBJECT_CODE_MISSING", "Subject code is missing"),
    SUBJECT_CODE_DUPLICATE("SUBJECT_CODE_DUPLICATE", "Subject code duplicate"),
    SUBJECT_CODE_TOO_LONG("SUBJECT_CODE_TOO_LONG", "Subject code too long"),
    SUBJECT_TITLE_MISSING("SUBJECT_TITLE_MISSING", "Subject title is missing"),
    SUBJECT_TITLE_TOO_LONG("SUBJECT_TITLE_TOO_LONG", "Subject title too long"),
    SUBJECT_UNITS_MISSING("SUBJECT_UNITS_MISSING", "Subject units is missing"),
    SUBJECT_UNITS_INVALID("SUBJECT_UNITS_INVALID", "Subject units has invalid value"),
